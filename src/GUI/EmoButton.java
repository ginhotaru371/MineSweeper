...
public class EmoButton extends JButton {
    ...
    public EmoButton(Notification p) {
        this.p = p;
    ...
    public void paint(Graphics g) {
        switch (stage) {
            case win:
                g.drawImage(p.getGame().getGameFrame().getLoadData().getListImage().get("emoWin"), 0, 0,
                        getPreferredSize().width, getPreferredSize().height, null);
                break;
            case lose:
                g.drawImage(p.getGame().getGameFrame().getLoadData().getListImage().get("emoLose"), 0, 0,
                        getPreferredSize().width, getPreferredSize().height, null);
                break;
            case press:
